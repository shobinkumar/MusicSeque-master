package com.musicseque.photopicker.activity;
...
import com.musicseque.photopicker.Constants;
import com.musicseque.photopicker.adapter.AlbumAdapter;
import com.musicseque.photopicker.adapter.ListAlbumAdapter;
import com.musicseque.photopicker.model.ImageModel;
import com.musicseque.photopicker.myinterface.IHandler;
import com.musicseque.photopicker.myinterface.OnAlbum;
import com.musicseque.photopicker.myinterface.OnListAlbum;
...
public class PickImageActivity extends AppCompatActivity implements  OnClickListener, OnAlbum, OnListAlbum {
    ...
    public static final int PICKER_REQUEST_CODE=1002;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    void addItemSelect(final ImageModel item) {
        ...
        Glide.with((Activity) this).load(item.getPathFile()).apply(options).into(imageItem);
