...
class ToTimeRecyclerAdapter(internal var activity: Activity, internal var alTime: ArrayList<String>?, internal var strArray: Array<String>, internal var timeInterface: TimeInterface) : RecyclerView.Adapter<ToTimeRecyclerAdapter.MyHolder>() {
